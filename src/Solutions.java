...
//
//        for (BigInteger i = new BigInteger("2"); i.compareTo(input) < 0; i = i.add(ONE)) {
//            BigInteger temp = new BigInteger(input.divide(i));
//        }
//        System.out.println("What is the largest prime factor of the number 600851475143 ?");
    ...
    public static void problem4() {
        ...
        for (Integer i = 100; i < 1000; i++) {
            for (Integer j = 100; j < 1000; j++) {
                ...
                if (reverse.equals(str) && largestPalindrome < Integer.parseInt(str)) {
                    largestPalindrome = Integer.parseInt(str);
                }
            }
        }
    ...
    public static void problem5() {
        /*
 This one can actually be solved analytically
...
*/
    ...
    public static void problem6() {
        ...
        int answer = sumOfSquares - squareOfSum;
    ...
    public static void problem7() {
        ...
        int[] primes = Functions.getPrimes(10001);
    ...
    public static void problem9() {
        ...
        System.out.println(triple[0] + " x " + triple[1] + " x " + triple[2] + " = " + triple[0] * triple[1] * triple[2]);
    ...
    public static void problem11() {
        ...
        for (int i = 0; i < 17; i++) {
            for (int j = 0; j < 17; j++) {
                ...
                if (grid[i][j] * grid[i][j + 1] * grid[i][j + 2] * grid[i][j + 3] > product) {
                    ...
                    numbers = updateNumbers(grid[i][j], grid[i][j + 1], grid[i][j + 2], grid[i][j + 3]);
                }
                // Columns
                if (grid[i][j] * grid[i + 1][j] * grid[i + 2][j] * grid[i + 3][j] > product) {
                    product = grid[i][j] * grid[i + 1][j] * grid[i + 2][j] * grid[i + 3][j];
                    numbers = updateNumbers(grid[i][j], grid[i + 1][j], grid[i + 2][j], grid[i + 3][j]);
                }
                if (grid[i][j] * grid[i + 1][j + 1] * grid[i + 2][j + 2] * grid[i + 3][j + 3] > product) {
                    product = grid[i][j] * grid[i + 1][j + 1] * grid[i + 2][j + 2] * grid[i + 3][j + 3];
                    numbers = updateNumbers(grid[i][j], grid[i + 1][j + 1], grid[i + 2][j + 2], grid[i + 3][j + 3]);
                }

                if (grid[i + 3][j] * grid[i + 2][j + 1] * grid[i + 1][j + 2] * grid[i][j + 3] > product) {
                    product = grid[i + 3][j] * grid[i + 2][j + 1] * grid[i + 1][j + 2] * grid[i][j + 3];
                    numbers = updateNumbers(grid[i + 3][j], grid[i + 2][j + 1], grid[i + 1][j + 2], grid[i][j + 3]);
                }
            }
        }
        ...
        System.out.println("Answer: " + numbers[0] + " x " + numbers[1] + " x " + numbers[2] + " x " + numbers[3] + " = " + product);
    }

    private static int[] updateNumbers(int i, int i1, int i2, int i3) {
        int[] array = new int[4];
    ...
    public static void problem12() {
        ...
        while (divisors < 100) {
            ...
            for (int i = 1; i <= triangularNumber / 2; i++) {
        ...
        System.out.println("Answer = " + triangularNumber + " has " + divisors + " divisors.");
    }
    ...
    public static void problem13() {
        ...
        for (int i = 49; i > 3; i--) {
            ...
            digits[i - 3] = digits[i] / 1000;
            digits[i - 2] = digits[i] / 100;
            digits[i - 1] = (digits[i] - digits [i - 2]) / 10;
            digits[i] %= 10;
        ...
        for(int i = 0; i < 10; i++) {
            ...
            sum += Math.pow(digits[i], 9 - i);
        }
        System.out.println("The first 10 digits are: " + sum);
    }
}
